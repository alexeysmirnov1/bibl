...
/* harmony import */ var _dadata__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../dadata */ "./resources/js/dadata.js");
/* harmony import */ var _debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../debounce */ "./resources/js/debounce.js");
/* harmony import */ var laravel_nova__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! laravel-nova */ "../../vendor/laravel/nova/resources/js/mixins/packages.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_3__.FormField, laravel_nova__WEBPACK_IMPORTED_MODULE_3__.HandlesValidationErrors],
  components: {
  ...
  computed: {
    debouncedGetAddresses: function debouncedGetAddresses() {
      var DELAY = 300;
      return (0,_debounce__WEBPACK_IMPORTED_MODULE_2__["default"])(this.getAddresses, DELAY);
    },
    addressCoords: function addressCoords() {
      return this.address && this.address.data && this.address.data.geo_lat ? [this.address.data.geo_lat, this.address.data.geo_lon] : [];
    }
  },
  methods: {
    addressChanged: function addressChanged(address) {
      var _this = this;
      if (_typeof(address) !== undefined && address.value !== null) {
        (0,_dadata__WEBPACK_IMPORTED_MODULE_1__.getData)(this.field.da_data_api_key, {
          query: address.value,
          restrict_value: true,
          count: 1
        }).then(function (success) {
          _this.bufferAddresses = success.suggestions;
          _this.address = _this.bufferAddresses[0];
          if (!_this.mapRendered) {
            _this.mapInit();
            _this.mapRendered = true;
          } else {
            var myGeoObject = new ymaps.GeoObject({
              geometry: {
                type: 'Point',
                coordinates: _this.addressCoords
              }
            }, {
            ...
            myGeoObject.events.add('dragend', _this.geoObjectsDragendHandler);
          }
        }, function (error) {
          return alert("\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0435 \u0430\u0434\u0440\u0435\u0441\u043E\u0432: ".concat(error.message));
        });
      }
    },
    geoObjectsDragendHandler: function geoObjectsDragendHandler(evt) {
      var coords = evt.get('target').geometry.getCoordinates();
      this.address.data.geo_lat = coords[0].toString();
      this.address.data.geo_lon = coords[1].toString();
    },
    getAddresses: function getAddresses(searchQuery) {
      var _this2 = this;
      (0,_dadata__WEBPACK_IMPORTED_MODULE_1__.getData)(this.field.da_data_api_key, {
        query: searchQuery,
        restrict_value: true
      }).then(function (success) {
        return _this2.addresses = success.suggestions;
      }, function (error) {
        return alert("\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0435 \u0430\u0434\u0440\u0435\u0441\u043E\u0432: ".concat(error.message));
      });
    },
    ...
    mapInit: function mapInit() {
      ...
      var settingsPart = "lang=".concat(settings.lang).concat(settings.apiKey && "&apikey=".concat(settings.apiKey), "&mode=release&coordorder=").concat(settings.coordorder);
      var link = "https://api-maps.yandex.ru/".concat(settings.version, "/?").concat(settingsPart);
      ...
      yandexMapScript.onload = function () {
        ymaps.ready(function () {
          _this3.map = new ymaps.Map('datata-address-map', {
            center: _this3.addressCoords,
            zoom: 12,
          ...
          var myGeoObject = new ymaps.GeoObject({
            geometry: {
              type: 'Point',
              coordinates: _this3.addressCoords
            }
          }, {
            preset: 'islands#greenDotIconWithCaption',
            draggable: true
          });
          _this3.map.geoObjects.add(myGeoObject);
          myGeoObject.events.add('dragend', _this3.geoObjectsDragendHandler);
        });
      };
    }
  },
  mounted: function mounted() {
    ...
    this.field.fill = function (formData) {
      formData.append(_this4.field.attribute, JSON.stringify(_this4.address));
    };
  }
});
...
var _hoisted_1 = {
  "class": "datata-address__map-wrapper"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_multiselect, {
        ...
        onSearchChange: _cache[1] || (_cache[1] = function ($event) {
          return $options.debouncedGetAddresses($event);
        }),
        modelValue: $data.address,
        onSelect: $options.addressChanged,
        "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
          return $data.address = $event;
        })
      }, {
        noResult: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return _cache[3] || (_cache[3] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Список пуст")]);
        }),
        noOptions: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return _cache[4] || (_cache[4] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Начните вводить адрес")]);
        }),
        clear: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          ...
          }, null, 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.address]])];
        }),
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["options", "modelValue", "onSelect"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, _cache[5] || (_cache[5] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        id: "datata-address-map",
        "class": "datata-address__map"
      }, null, -1 /* HOISTED */)]), 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.mapRendered]])];
    }),
    _: 1 /* STABLE */
...
/* harmony import */ var _var_www_nova_components_DaDataAddressYandexMap_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_var_www_nova_components_DaDataAddressYandexMap_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var _var_www_nova_components_DaDataAddressYandexMap_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
var getData = function getData(api_key, options) {
  return new Promise(function (resolve, reject) {
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("https://suggestions.dadata.ru/suggestions/api/4_1/rs/suggest/address", options, {
      headers: {
        'Content-Type': 'application/json',
...
Nova.booting(function (app, store) {
  app.component('index-da-data-address-yandex-map', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-da-data-address-yandex-map', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-da-data-address-yandex-map', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkflagstudio_da_data_address_yandex_map"] = self["webpackChunkflagstudio_da_data_address_yandex_map"] || [];
